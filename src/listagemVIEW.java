...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    public void atualizarTabela(){
        ...
        List<ProdutosDTO> listaCompleta = ListaProdutos.Listar();
    ...
    private void preencherTabela() {
        ...
        String prod = id_produto_venda.getText();
        List<ProdutosDTO> ListaProdutos = produtosdao.listarProdutos(prod);
        
        DefaultTableModel tabelaProduto =  (DefaultTableModel) listaProdutos.getModel();
         
        tabelaProduto.setNumRows(0);
        
        for (ProdutosDTO r : ListaProdutos) {
    ...
    /*private void listarProdutos(){
        try {
            ...
            ArrayList<ProdutosDTO> listagem = produtosdao.cadastrarProduto();
